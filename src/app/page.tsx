    ...
    <MainLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-16 px-4 max-w-6xl mx-auto">
        <BlurFade delay={0.25} inView>
          <Card className="border-2 border-black shadow-pixel hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all bg-card h-full">
            <CardHeader>
        ...
        <BlurFade delay={0.35} inView>
          <Card className="border-2 border-black shadow-pixel hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all bg-card h-full">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Monitor your spending habits with instant updates. Visual
                progress bars keep you on track.
              </p>
            </CardContent>
          </Card>
        </BlurFade>
